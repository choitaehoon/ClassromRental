...
<body>
	...
	<form action="transmit" method="post">
		...
		3.물건을 제자리에 놓았습니까? &nbsp; 예<input type="radio" name="q3"
			...
			type="text" name="question3" style="width: 500px; height: 20px;"><br />
		4.의자,책상 등 잘 정리하고 갔습니까? &nbsp; 예<input type="radio" name="q4"
			...
			type="text" name="question4" style="width: 500px; height: 20px;"><br />
		5.온,냉방시설을 제대로 끄고 갔습니까? &nbsp; 예<input type="radio" name="q5"
			...
			type="text" name="question5" style="width: 500px; height: 20px;"><br />
