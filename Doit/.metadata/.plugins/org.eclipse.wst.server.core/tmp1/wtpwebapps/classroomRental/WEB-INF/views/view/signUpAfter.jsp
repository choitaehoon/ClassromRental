...
<div id="abcd">${user.loginId}님환영합니다.
	...
	<input type="button" class="btn btn-success" value="승인요청목록"
			onclick="location.href='http://localhost:8080/controller/view/showStaff'">
	<input type="button" class="btn btn-success" value="승인요청"
			onclick="location.href='http://localhost:8080/controller/view/approvalEx'">
	<a href="signUpAfter" class="btn">초기 화면으로 나가기 </a>
